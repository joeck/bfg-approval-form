		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SO Automation Approval",
									"targetURL": "#bfgmgntapprworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bfgmgntapprworkflowuimodule-display": {
								"semanticObject": "bfgmgntapprworkflowuimodule",
								"action": "display",
								"description": "Approve / Reject automated processing",
								"title": "SO Automation Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bfgmgntappr.workflowuimodule",
									"url": sap.ui.require.toUrl("bfgmgntappr/workflowuimodule")
								}
							}
						}
					}
